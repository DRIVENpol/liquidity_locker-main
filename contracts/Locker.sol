...
contract Rev3al_Locker is ReentrancyGuard {
    ...
    /** Constructor */
    constructor(uint128 _lockFee, address _owner) {
    ...
    function withdrawERC20(address token) external payable onlyOwner {
        ...
        IERC20(token).safeTransfer(owner, _delta);
    }
    ...
    function withdrawFromPinged(uint128 _lockId, address _receiver) external payable onlyOwner {
        ...
        IERC20(_lock.token).safeTransfer(_receiver, _amount);
    ...
    /** Internal functions */
    function safeTransferAllETH() internal {
